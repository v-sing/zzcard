...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="admin/static/business/css/style.css" />
    <!--[if IE 6]>
                ...
                <dd class="Hui-menu-item">
                    <ul>
                        @foreach($v['children'] as $v2)
                                        ...
                                        <dd class="Hui-menu-item">
                                            <ul>
                                                @foreach($v2['children'] as $v3)
                                                    <li><a data-href="{{$v3['url']}}" data-title="{{$v3['menu_name']}}" href="javascript:void(0)">{{$v3['menu_name']}}</a></li>
                                                @endforeach
                                            </ul>
                                        </dd>
                                    </dl>
                            ...
                            @else
                                <li><a data-href="{{$v2['url']}}" data-title="{{$v2['menu_name']}}" href="javascript:void(0)">{{$v2['menu_name']}}</a></li>
                            @endisset
                        @endforeach
                    </ul>
                </dd>
