        ...
        <div class="layui-row">
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux">
                        <a title="查看图标"  href="/admin/static/xadmin/fonts/demo_index.html" target="_blank"><i class="icon iconfont" style="font-size: 20px;color: #ffae8f;">&#xe657;</i></a>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="padding-top: 9px">
                        <input type="checkbox" name="is_show" lay-skin="switch"  @if($info->is_show) checked  @endif>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="username" class="layui-form-label">
                    ...
                    <div class="layui-input-inline">
                        <input type="text"  name="crux_sort" required="" lay-verify="required"
                               autocomplete="off" class="layui-input" value="{{$info->crux_sort}}" placeholder="">
                    </div>
                    {{--<div class="layui-form-mid layui-word-aux">
                        <span class="x-red">*</span>
                    </div>--}}
    ...
    <script>
        layui.use(['form', 'layer'],
            function () {
                ...
                form.on('submit(add)',
                    function (data) {
                        $.post('/admin/menu/edit',data.field,function (res) {
