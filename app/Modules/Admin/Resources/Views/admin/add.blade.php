        ...
        <div class="layui-row">
            <form class="layui-form" lay-filter="form1">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="password" name="password" lay-verify="pass" lay-verify="required" autocomplete="off" class="layui-input" value="{{ $admin->password?decrypt($admin->password):'' }}">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="password"  name="password2" lay-verify="required" autocomplete="off" class="layui-input" value="{{$admin->password?decrypt($admin->password):'' }}">
                    </div>
                </div>
