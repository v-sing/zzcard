            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-header">
                        @adminAuth('/admin/admin/add')
                        <button class="layui-btn" onclick="xadmin.open('添加管理员','/admin/admin/add',600,450)"><i
                            ...
                            @foreach($list as $v)
                                <tr>
                                    ...
                                    <td class="td-manage">
                                        ...
                                        @adminAuth('/admin/admin/add')
                                        <a title="编辑"
                                           onclick="xadmin.open('编辑','/admin/admin/add?id={{$v->id}}',600,450)"
                                           href="javascript:;"><i class="icon iconfont"
                                                                  style="font-size: 20px;color: #7197ff;">&#xe63c;</i></a>
                                        @endadminAuth
                                        @adminAuth('/admin/admin/del')
    ...
    <script>
        ...
        function member_del(obj, id) {
            layer.confirm('角色删除须谨慎，确认要删除吗？', function (index) {
                $.post('/admin/admin/del',{id:id},function (re) {
        ...
        function member_stop(obj,id){
            ...
            layer.confirm('确认要'+title+'吗？',function(index){
                $.post('/admin/admin/stop',{id:id,status:status},function (re){
                    if (re.status == 'success') {
                        if(status==1){
                            $(obj).attr('title','停用');
                            $(obj).find('i').html('&#xe77e;');
