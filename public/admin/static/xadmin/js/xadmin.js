;!function (win) {
  ...
  Xadmin.prototype.end = function() {
    ...
    for(var i in cate_list){
      if(cate_list[i]!=null){
        $('.left-nav .ul_nav li').eq(cate_list[i]).click();
      }
    }
  };
...
layui.use(['layer','element','jquery'],function() {
    ...
    //左侧菜单
    $('.left-nav .ul_nav').on('click', 'li', function(event) {

        if($(this).parent().attr('id')=='nav'){
          xadmin.set_cate_data({key:'f1',value:$('.left-nav .ul_nav li').index($(this))})
          xadmin.set_cate_data({key:'f2',value:null})
          xadmin.set_cate_data({key:'f3',value:null})
        }

        if($(this).parent().parent().parent().attr('id')=='nav'){
          xadmin.set_cate_data({key:'f2',value:$('.left-nav .ul_nav li').index($(this))})
          xadmin.set_cate_data({key:'f3',value:null})
        }

        if($(this).parent().parent().parent().parent().parent().attr('id')=='nav'){
          xadmin.set_cate_data({key:'f3',value:$('.left-nav .ul_nav li').index($(this))})
        }
    ...
    $('.left-nav .ul_nav').on('mouseenter', '.left-nav-li', function(event) {
    ...
    $('.left-nav .ul_nav').on('mouseout', '.left-nav-li', function(event) {
